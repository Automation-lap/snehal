...
public class Example3 {
	...
	public static void main(String[] args) {
     ...
     System.out.println("booleanVariable = "+charVariable);
...
+---------> LHS + RHS ===> both are number then it will perform addition operation.
  25 + 35 = 60

+---------> LHS + RHS ===> if anyone from LHS or RHS are non numeric then it will perform concatination operation.
  "Hello" + 65 = Hello65
  205 + "Hi" = 20Hi
