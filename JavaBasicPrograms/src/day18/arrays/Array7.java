...
public class Array7 {
	...
	public static void main(String[] args) {
		System.out.println("***************************************************");
          ...
          int empId=101, empId2=102, empId3=103;
           int[] empId=new int[3];
          empId[0]=101;
          empId[1]=102;
          empId[2]=103;
          ...
          System.out.println("***************************************************");
      //  Example2[] e=new Example2[] {newExample2[],new Example2(),new Example2(15),new Example2(25.36)};    
          //or
      // Example2[] e={new Example2(),new Example2(15),new Exampe2(25.36)};
          //or
