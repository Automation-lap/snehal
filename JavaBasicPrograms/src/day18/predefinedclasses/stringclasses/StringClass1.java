...
System.out.println("s1 & s3 using '==': "+(s1==s2));//compare s1 & s2 based on address
...
System.out.println("s4 & s5 using '==': "+(s4==s5));//compae s5 & s4 based on address --->
...
/**
 * string ---> 
            predefined class in java belongs to java. long package
            it represents group/collection of characters
            in String class following method are override
