...
public class Example6 {
	...
	public static void main(String[] args) {
		...
		System.out.println("s2: toString of ObjectClass4: "+s2.hashCode());//
		...
		Print p1=new Print();
		System.out.println("totring of Print: "+p1);//
		...
		System.out.println("Comapring Print class object p1 & p2 with overriden equals() :"+p1.equals(p2));//
